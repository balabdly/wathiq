...
const NAV_ITEMS = [
  ...
  { href: '/hr', label: 'الموارد البشرية', perm: 'employees', module: null, icon: 'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75M12 7a4 4 0 110 8 4 4 0 010-8z' },
