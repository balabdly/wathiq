...
const HR_ITEMS = [
  ...
  { href: '/hr/payroll',    label: 'الرواتب والتعويضات',          icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
          ...
          <div>
            <button onClick={() => setHrOpen(!hrOpen)}
              ...
              style={{ width: '100%', justifyContent: 'space-between',
                background: isHRActive ? 'rgba(255,255,255,0.2)' : hrOpen ? 'rgba(255,255,255,0.15)' : 'transparent' }}>
            ...
            {hrOpen && (
              <div style={{ marginTop: '2px', marginRight: '8px', borderRight: '2px solid rgba(255,255,255,0.3)', paddingRight: '8px' }}>
                {HR_ITEMS.map(item => {
                  const active = pathname === item.href
                  return (
                    <Link key={item.href} href={item.href}
                      className={`sidebar-item ${active ? 'active' : ''}`}
                      style={{ fontSize: '0.825rem', padding: '8px 10px', background: 'rgba(255,255,255,0.06)', borderRadius: '6px', marginBottom: '2px' }}>
