...
const NAV_ITEMS = [
  { href: '/dashboard', label: 'لوحة التحكم', perm: 'dashboard', icon: 'M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z' },
  { href: '/projects',  label: 'المشاريع',    perm: 'projects_view', icon: 'M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z' },
  { href: '/visits',    label: 'الزيارات الفنية', perm: 'visits_quality', icon: 'M9 11l3 3L22 4M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11' },
  { href: '/qhse',      label: 'السلامة والجودة', perm: 'qhse', icon: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z' },
  { href: '/inventory', label: 'المخزون',     perm: 'inventory', icon: 'M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z' },
  { href: '/purchases', label: 'المشتريات',   perm: 'purchases', icon: 'M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4zM3 6h18M16 10a4 4 0 01-8 0' },
  { href: '/employees', label: 'الموظفون',    perm: 'employees', icon: 'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75' },
  { href: '/reports',   label: 'التقارير',    perm: 'reports', icon: 'M18 20V10M12 20V4M6 20v-6' },
]
